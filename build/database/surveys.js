...
exports.delete_survey_by_survey_id =
  exports.update_survey_for_survey_id =
  exports.create_survey_for_email =
  exports.get_survey_list_for_email__public =
  exports.get_survey_list__public =
  exports.get_survey_list__owner =
  exports.get_survey_list__public_or_owner =
  exports.get_survey_list__all =
  exports.get_survey_list_for_email__owner =
  exports.get_survey_list_for_email__public_or_owner =
  exports.get_survey_list_for_email__all =
  exports.get_survey_for_survey_id__owner =
  exports.get_survey_for_survey_id__all =
  exports.get_survey_for_survey_id__public_or_owner =
  exports.get_survey_for_survey_id__public =
  exports.isPublic_survey =
  exports.isOwner_survey =
    void 0;
var db_1 = require("./db");
...
//
// ###############################################################################
var isOwner_survey = function (survey_id, email) {
...
//
// ###############################################################################
var isPublic_survey = function (survey_id) {
  return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
//
// ###############################################################################
var get_survey_for_survey_id__public = function (survey_id) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
//
// ###############################################################################
var get_survey_for_survey_id__public_or_owner = function (survey_id, email) {
  return __awaiter(void 0, void 0, void 0, function () {
    var account_id;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
//
// ###############################################################################
var get_survey_for_survey_id__all = function (survey_id) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
//
// ###############################################################################
var get_survey_for_survey_id__owner = function (survey_id, email) {
  return __awaiter(void 0, void 0, void 0, function () {
    var account_id;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
//
// ###############################################################################
var get_survey_list_for_email__all = function (
  email,
  order_by,
  page,
  per_page,
...
//
// ###############################################################################
var get_survey_list_for_email__public_or_owner = function (
  email,
  order_by,
  page,
  per_page,
...
//
// ###############################################################################
var get_survey_list_for_email__owner = function (
  email,
  order_by,
  page,
  per_page,
...
//
// ###############################################################################
var get_survey_list__public_or_owner = function (
  email,
  order_by,
  page,
  per_page,
...
//
// ###############################################################################
var get_survey_list_for_email__public = function (
  email,
  order_by,
  page,
  per_page,
...
//
// ###############################################################################
var create_survey_for_email = function (email, survey_title) {
  return __awaiter(void 0, void 0, void 0, function () {
    var account_id;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
//
// ###############################################################################
var update_survey_for_survey_id = function (survey_title, pub, survey_id) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
//
// ###############################################################################
var delete_survey_by_survey_id = function (survey_id) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
