 ...
 */
// -------------------------------------------------------------------------------
var performQuery = function (query, kwargs) { return __awaiter(void 0, void 0, void 0, function () {
    var client, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, client.query(named(query)(kwargs))];
            case 3: return [2 /*return*/, _a.sent()];
            case 4:
                error_1 = _a.sent();
                return [2 /*return*/, console.log("Query error: ", error_1)];
            case 5:
                client.release();
                return [7 /*endfinally*/];
