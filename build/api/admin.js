...
var db_reset_1 = require("../database/db_reset");
var auth_1 = require("../utils/auth");
var status_1 = require("../utils/status");
//
//
router.get("/reset-database", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, db_reset_1.resetDatabase()];
            case 1:
                result = _a.sent();
                return [2 /*return*/, res
